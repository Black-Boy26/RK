...
logo = "\n\x1b[1;92m  /$$$$$$$  /$$$$$$ /$$      /$$  /$$$$$$  /$$   /$$\n | $$__  $$|_  $$_/| $$$    /$$$ /$$__  $$| $$$ | $$ \n | $$  \ $$  | $$  | $$$$  /$$$$| $$  \ $$| $$$$| $$\n | $$$$$$$/  | $$  | $$ $$/$$ $$| $$  | $$| $$ $$ $$\n | $$__  $$  | $$  | $$  $$$| $$| $$  | $$| $$  $$$$  \n | $$  \ $$  | $$  | $$\  $ | $$| $$  | $$| $$\  $$$\n | $$  | $$ /$$$$$$| $$ \/  | $$|  $$$$$$/| $$ \  $$  \n |__/  |__/|______/|__/     |__/ \______/ |__/  \__/\n \n\x1b[0;91m\x1b[1;92m               [ MAKE FILE ]                 \x1b[1;93m\n-----------------------------------------------\n\x1b[0;91m \x1a AUTHOR : Black - Boy   \n\x1b[1;92m \x1a Github : Black-Boy\n\x1b[0;91m \x1a Note   : << Use Only Kiwi Browser Token >>"
...
def haha():
    ...
    print '\x1b[1;91m[\x1b[1;93m1\x1b[1;91m]\x1b[1;92m Make File'

    time.sleep(0.2)

    print '\x1b[1;91m[\x1b[1;93m2\x1b[1;91m]\x1b[1;97m Exit'
    ...
    ok = raw_input('\x1b[1;92m[\x1b[1;93m?\x1b[1;92m]\x1b[1;91m Select : \x1b[1;92m')

    if ok == '':

        print '\x1b[1;91m[\x1b[1;97m!\x1b[1;91m] \x1b[1;92mWrong Input'
...
def login():
    ...
    print '\x1b[0;93m          I N P U T   T O K E N      '
    ...
    try:
        ...
        ___token___ = raw_input(' %s[%sR K%s]%s T O K E N  :%s ' % (B, P, B, P, K))

        if ___token___ in ('', ' '):

            exit('%s[%s!%s]%sNEW TOKEN DAW ' % (P, M, P, M))

        xwx = requests.get('https://graph.facebook.com/me/?access_token=%s' % ___token___).json()

        print '%s[%s*%s]%s WelCome To SOHAILO %s %s' % (B, P, B, P, H, xwx['name'].lower())
...
def menu():
    ...
    print '\x1b[1;93mNote      : Past Ony Uid Not Uid And Name'

    print '\x1b[1;91mExample: /sdcard/Sohail.txt'
